...
class CameraViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate, ItemSelectionViewControllerDelegate, AVCapturePhotoCaptureDelegate {
        ...
        if let error = error {
            ...
            if let sampleBuffer = photoSampleBuffer,
                ...
                if UIImage(data: dataImage) != nil{
                    ...
                    let r = STHTTPRequest(urlString: "https://www.appitt.com/YHack/handleImage.php")
                    //r!.addData(toUpload: dataImage, parameterName: "imgfile")
                    r!.addData(toUpload: dataImage, parameterName: "imgfile", mimeType: "image/jpeg", fileName: "filename")
